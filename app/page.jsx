                ...
                {anime.trailer_url && (
                  activeTrailer === anime.mal_id ? (
                    <button
                      ...
                      className="absolute top-2 right-2 z-20 bg-black/50 hover:bg-red-600 p-2 rounded-full backdrop-blur-sm transition-colors duration-200"
                      aria-label={`Close trailer for ${anime.title}`}
                    >
